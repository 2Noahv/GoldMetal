...
public class Player : MonoBehaviour
{
	...
	void Move()
	{
		...
		//소문자 transfrom는 MonoBehaviour의 변수이다.
		//transfrom 이동에는 Time.DeltaTime를 꼭 사용하기 (물리적인 이동제외)
	...
	void Fire()
	{
		...
		switch (power) {
			...
			case 2:
				...
				rigidR.AddForce((Vector2.up * 7), ForceMode2D.Impulse);
				rigidL.AddForce((Vector2.up * 7), ForceMode2D.Impulse);
				break;
			case 3:
